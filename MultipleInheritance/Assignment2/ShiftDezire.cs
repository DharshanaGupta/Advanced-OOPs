...
namespace Assignment2
{
    public class ShiftDezire:Car,IBrand
    {
        ...
        public ShiftDezire(string fuleType,int numberOfSeats,string color,int tankCapacity,int numberOfKmDriven,string brandName,string modelName,int engineNumber,
